...
**Default = bắn vào CHÍNH chat hiện tại** (nơi user yêu cầu). Nếu user yêu cầu trong group, reminder bắn lại vào group đó (mọi người trong group đều thấy). Nếu user yêu cầu trong DM, bắn vào DM. Dùng \`recipientType="chat"\` + \`recipientChatId=<chatId hiện tại từ system prompt>\`.

Ví dụ:
- "Nhắc tôi 9h gọi Toyota" (trong group) → bắn vào group hiện tại — recipientType="chat".
- "Nhắc cả nhóm họp 14h" → bắn vào group hiện tại — recipientType="chat".
- "Nhắc tôi 1p nữa test" (trong DM) → bắn vào DM của user — recipientType="chat" với chatId của DM.
